  ...
  return (
    <Container fluid>
      <Row className={styles.container}>
        ...
        <Row>
              <b><i><h1 className=" border p-3 text-secondary bg-dark text-white text-bold mb-4 ">Welcome to FLIPZON Shopping Application !!</h1></i></b>
            </Row>
        </center>
          <div className={styles.colWithButtons}>
            <fieldset class="border p-2  text-primary text-center text-dark"> <h3 class="border p-3 mb-3 bg-light text-dark"> Please Sign In/ Sign Up </h3>
              <legend class="w-auto">
